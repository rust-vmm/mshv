...
impl Mshv {
    ...
    fn get_host_partition_property_ex(
        ...
        let mut args = mshv_root_hvcall {
            code: HVCALL_GET_PARTITION_PROPERTY_EX as u16,
            in_sz: std::mem::size_of_val(&input) as u16,
            out_sz: std::mem::size_of_val(output.as_ref()) as u16,
    ...
    pub fn get_vmm_capabilities(&self) -> Result<hv_partition_property_vmm_capabilities> {
