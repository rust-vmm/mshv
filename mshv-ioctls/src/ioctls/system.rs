...
impl MshvPartitionBuilder {
    ...
    pub fn enable_sev_vmgexit_offload(
        ...
        match feature {
            ...
            SevVmgExitOffload::NaeIoPort => unsafe {
                self.mshv_partition
                    .vmgexit_offload_features
                    .__bindgen_anon_1
                    .set_nae_io_port(1);
...
impl Mshv {
    ...
    fn _create_vm(&self, is_snp: bool) -> Result<VmFd> {
    ...
    /// Creates a VM fd using the MSHV fd of given vm_type.
    pub fn create_vm_with_type(&self, vm_type: u64) -> Result<VmFd> {
        match vm_type {
            0 => self._create_vm(false),
            1 => self._create_vm(true),
