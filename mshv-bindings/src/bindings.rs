...
pub const hv_message_type_HVMSG_UNACCEPTED_GPA_INTERCEPT: hv_message_type = 2147483651;
...
pub const hv_partition_property_code_HV_PARTITION_PROPERTY_SEV_VMEXIT_OFFLOADS:
...
pub struct hv_input_modify_sparse_spa_page_host_access {
    ...
    pub spa_page_list: __IncompleteArrayField<__u32>,
}
#[test]
...
impl hv_sev_vmgexit_offload__bindgen_ty_1 {
    ...
    #[inline]
    pub fn nae_io_port(&self) -> __u64 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(2usize, 1u8) as u64) }
    }
    #[inline]
    pub fn set_nae_io_port(&mut self, val: __u64) {
        unsafe {
            let val: u64 = ::std::mem::transmute(val);
            self._bitfield_1.set(2usize, 1u8, val as u64)
        }
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(2usize, 1u8, {
            let nae_io_port: u64 = unsafe { ::std::mem::transmute(nae_io_port) };
            nae_io_port as u64
        });
        __bindgen_bitfield_unit.set(3usize, 1u8, {
...
pub struct mshv_create_partition {
    ...
    pub isolation_properties: hv_partition_isolation_properties,
    pub vmgexit_offload_features: hv_sev_vmgexit_offload,
}
#[test]
fn bindgen_test_layout_mshv_create_partition() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).vmgexit_offload_features) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(mshv_create_partition),
            "::",
            stringify!(vmgexit_offload_features)
        )
    );
}
...
fn bindgen_test_layout_mshv_read_write_gpa() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).byte_cpunt) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(mshv_read_write_gpa),
            "::",
            stringify!(byte_cpunt)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).flags) as usize - ptr as usize },
