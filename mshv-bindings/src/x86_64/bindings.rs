...
pub const HV_X64_USE_MMIO_HYPERCALLS: u32 = 2097152;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of hv_dispatch_suspend_register__bindgen_ty_1"]
        [::std::mem::size_of::<hv_dispatch_suspend_register__bindgen_ty_1>() - 8usize];
    ["Alignment of hv_dispatch_suspend_register__bindgen_ty_1"]
        [::std::mem::align_of::<hv_dispatch_suspend_register__bindgen_ty_1>() - 1usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of hv_dispatch_suspend_register"]
        [::std::mem::size_of::<hv_dispatch_suspend_register>() - 8usize];
    ["Alignment of hv_dispatch_suspend_register"]
        [::std::mem::align_of::<hv_dispatch_suspend_register>() - 8usize];
    ["Offset of field: hv_dispatch_suspend_register::as_uint64"]
        [::std::mem::offset_of!(hv_dispatch_suspend_register, as_uint64) - 0usize];
};
...
const _: () = {
    ...
    ["Offset of field: hv_register_value::dispatch_suspend"]
        [::std::mem::offset_of!(hv_register_value, dispatch_suspend) - 0usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of hv_proximity_domain_flags"]
        [::std::mem::size_of::<hv_proximity_domain_flags>() - 4usize];
    ["Alignment of hv_proximity_domain_flags"]
        [::std::mem::align_of::<hv_proximity_domain_flags>() - 1usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of hv_proximity_domain_info"]
        [::std::mem::size_of::<hv_proximity_domain_info>() - 8usize];
    ["Alignment of hv_proximity_domain_info"]
        [::std::mem::align_of::<hv_proximity_domain_info>() - 1usize];
    ["Offset of field: hv_proximity_domain_info::domain_id"]
        [::std::mem::offset_of!(hv_proximity_domain_info, domain_id) - 0usize];
    ["Offset of field: hv_proximity_domain_info::flags"]
        [::std::mem::offset_of!(hv_proximity_domain_info, flags) - 4usize];
};
#[repr(C)]
#[derive(Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of hv_input_modify_sparse_spa_page_host_access"]
        [::std::mem::size_of::<hv_input_modify_sparse_spa_page_host_access>() - 16usize];
    ["Alignment of hv_input_modify_sparse_spa_page_host_access"]
        [::std::mem::align_of::<hv_input_modify_sparse_spa_page_host_access>() - 1usize];
    ["Offset of field: hv_input_modify_sparse_spa_page_host_access::flags"]
        [::std::mem::offset_of!(hv_input_modify_sparse_spa_page_host_access, flags) - 4usize];
    ["Offset of field: hv_input_modify_sparse_spa_page_host_access::partition_id"][::std::mem::offset_of!(
        hv_input_modify_sparse_spa_page_host_access,
        partition_id
    ) - 8usize];
    ["Offset of field: hv_input_modify_sparse_spa_page_host_access::spa_page_list"][::std::mem::offset_of!(
        hv_input_modify_sparse_spa_page_host_access,
        spa_page_list
    ) - 16usize];
};
...
pub const mshv_hv_vp_state_page_type_MSHV_VP_MMAP_OFFSET_REGISTERS: mshv_hv_vp_state_page_type = 0;
pub const mshv_hv_vp_state_page_type_MSHV_VP_MMAP_OFFSET_INTERCEPT_MESSAGE:
    mshv_hv_vp_state_page_type = 1;
pub const mshv_hv_vp_state_page_type_MSHV_VP_MMAP_OFFSET_GHCB: mshv_hv_vp_state_page_type = 2;
pub const mshv_hv_vp_state_page_type_MSHV_VP_MMAP_OFFSET_COUNT: mshv_hv_vp_state_page_type = 3;
pub type mshv_hv_vp_state_page_type = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialOrd, Ord, PartialEq, Eq)]
