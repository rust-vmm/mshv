...
pub const MSHV_VP_FLAG_BIT_IMMEDIATE_EXIT: _bindgen_ty_13 = 0;
pub const MSHV_VP_FLAG_BIT_COUNT: _bindgen_ty_13 = 1;
pub type _bindgen_ty_13 = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialOrd, Ord, PartialEq, Eq)]
pub struct mshv_vp_flags {
    pub bits: __u8,
    pub rsvd: [__u8; 7usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mshv_vp_flags"][::std::mem::size_of::<mshv_vp_flags>() - 8usize];
    ["Alignment of mshv_vp_flags"][::std::mem::align_of::<mshv_vp_flags>() - 1usize];
    ["Offset of field: mshv_vp_flags::bits"][::std::mem::offset_of!(mshv_vp_flags, bits) - 0usize];
    ["Offset of field: mshv_vp_flags::rsvd"][::std::mem::offset_of!(mshv_vp_flags, rsvd) - 1usize];
};
pub const MSHV_DEV_TYPE_VFIO: _bindgen_ty_14 = 0;
pub const MSHV_DEV_TYPE_MAX: _bindgen_ty_14 = 1;
