...
/// Assemble a RepInput<T> structure from a hypercall input struct and rep data.
/// Arguments:
///             1. The hv_input_* struct with the input data
///             2. Name of the __IncompleteArrayField<T> in the struct
///             4. An array or slice containing the rep data
#[macro_export]
...
/// Populate a mshv_root_hvcall struct with rep hypercall parameters
/// Arguments:
///     1. hypercall code
...
/// Populate a mshv_root_hvcall struct with regular hypercall parameters
/// Arguments:
///     1. hypercall code
